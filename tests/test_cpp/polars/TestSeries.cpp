...
TEST(Series, arctan_regular_case){

    EXPECT_PRED2(
            Series::equal,
            Series({0.07677189126977804, 0.5880026035475675, 0.04441521524691084, 0.15534206565122174, 2.214297435588181}, {1, 2, 3, 4, 5}),
            Series::arctan(Series({0.1, 0.2, 0.2, 0.83, 0.4}, {1, 2, 3, 4, 5}), Series({1.3, 0.3, 4.5, 5.3, -0.3}, {1, 2, 3, 4, 5}))
    ) << "Expect" << " series where each element is the arctan of the corresponding series components in x and y.";
